  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2">
        ...
        {activeTab === 'lookup' && (
          <div className="space-y-2">
            <h2 className="text-lg font-bold text-white mb-2">User Lookup & Analysis</h2>
        ...
        {activeTab === 'announcements' && (
          <div className="space-y-2">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 border border-white/20">
              <h3 className="text-base font-semibold text-white mb-2">Existing Announcements</h3>
        ...
        {activeTab === 'support' && (
          <div className="space-y-2">
            <h2 className="text-lg font-bold text-white mb-2">Support Management</h2>
        ...
        {activeTab === 'analytics' && globalAnalytics && (
          <div className="space-y-2">
            <h2 className="text-lg font-bold text-white mb-2">Global Analytics</h2>
        ...
        {activeTab === 'users' && (
          <div className="space-y-2">
            <h2 className="text-lg font-bold text-white mb-2">All Users Overview</h2>
